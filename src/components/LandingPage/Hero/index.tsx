  ...
  return (
    <section id="hero">
      ...
      <div className="hero-cards">
        ...
        <img src={imagens.casaModerna} alt="Casa Moderna" className="hero-background" />
        ...
        <div className="hero-card">
        <img src={imagens.predioCorporativo} alt="Prédio Corporativo" className="hero-background" />
        <div className='content'>
        ...
        <div className="hero-card">
        <img src={imagens.designInteriores} alt="Design de Interiores" className="hero-background" />
        <div className='content'>
